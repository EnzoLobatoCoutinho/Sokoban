...
int condition_verif2db(int calcul)
{
...
int condition_verifdouble(int calcul)
{
    ...
    condition_verif2db(calcul);
}

double my_put_posdouble(int calcul)
{
    int i = 0;
